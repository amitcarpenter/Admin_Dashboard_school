...
// Use Middle ware
app.use(cors())
app.use('/build', express.static(path.join(__dirname, '../frontend_admin/build')));
app.use('/dist', express.static(path.join(__dirname, '../frontend_admin/dist')));
app.use('/docs', express.static(path.join(__dirname, '../frontend_admin/docs')));
app.use('/pages', express.static(path.join(__dirname, '../frontend_admin/pages')));
app.use('/plugins', express.static(path.join(__dirname, '../frontend_admin/plugins')));
app.use(express.static('public'));
